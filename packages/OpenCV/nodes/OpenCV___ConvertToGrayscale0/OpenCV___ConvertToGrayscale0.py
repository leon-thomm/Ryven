...
class ConvertToGrayscale_NodeInstance(NodeInstance):
    def __init__(self, parent_node: Node, flow, configuration=None):
        super(ConvertToGrayscale_NodeInstance, self).__init__(parent_node, flow, configuration)
    ...
    def update_event(self, input_called=-1):
        result = cv2.cvtColor(self.input(0), cv2.COLOR_BGR2GRAY)
