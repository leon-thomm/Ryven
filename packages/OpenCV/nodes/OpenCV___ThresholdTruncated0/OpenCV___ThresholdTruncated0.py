...
class ThresholdTruncated_NodeInstance(NodeInstance):
    def __init__(self, parent_node: Node, flow, configuration=None):
        super(ThresholdTruncated_NodeInstance, self).__init__(parent_node, flow, configuration)
    ...
    def update_event(self, input_called=-1):
        ...
        ret, result = cv2.threshold(grayImage, self.input(1), self.input(2), cv2.THRESH_TRUNC)
