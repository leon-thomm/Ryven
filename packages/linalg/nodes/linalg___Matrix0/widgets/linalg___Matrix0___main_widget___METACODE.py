...
class %NODE_TITLE%_NodeInstance_MainWidget(matrix_widget.MatrixWidget):
    def __init__(self, parent_node_instance):
        super(%NODE_TITLE%_NodeInstance_MainWidget, self).__init__(parent_node_instance, 100, 80)
