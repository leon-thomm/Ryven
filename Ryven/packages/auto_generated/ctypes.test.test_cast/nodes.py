...
class Array_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.ARRAY(self.input(0), self.input(1)))
...
class Cfunctype_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.CFUNCTYPE(self.input(0)))
...
class Dllcanunloadnow_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.DllCanUnloadNow())
...
class Dllgetclassobject_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.DllGetClassObject(self.input(0), self.input(1), self.input(2)))
...
class Pyfunctype_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.PYFUNCTYPE(self.input(0)))
...
class Setpointertype_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.SetPointerType(self.input(0), self.input(1)))
...
class Winfunctype_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.WINFUNCTYPE(self.input(0)))
...
class Winerror_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.WinError(self.input(0), self.input(1)))
...
class _Calcsize_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast._calcsize(self.input(0)))
...
class _Check_Size_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast._check_size(self.input(0), self.input(1)))
...
class _Reset_Cache_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast._reset_cache())
...
class C_Buffer_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.c_buffer(self.input(0), self.input(1)))
...
class Cast_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.cast(self.input(0), self.input(1)))
...
class Create_String_Buffer_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.create_string_buffer(self.input(0), self.input(1)))
...
class Create_Unicode_Buffer_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.create_unicode_buffer(self.input(0), self.input(1)))
...
class String_At_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.string_at(self.input(0), self.input(1)))
...
class Wstring_At_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.test.test_cast.wstring_at(self.input(0), self.input(1)))
