...
class ChooseUnitsIW_PortInstanceWidget(QWidget, IWB):
    def __init__(self, params):
        ...
        self.units_kelvin.toggled.connect(self.set_units_kelvin)
        layout.addWidget(self.units_kelvin)
        self.units_celsius = QRadioButton('Celsius')
        self.units_celsius.toggled.connect(self.set_units_celsius)
        layout.addWidget(self.units_celsius)
        self.units_fahrenheit = QRadioButton('Fahrenheit')
        self.units_fahrenheit.toggled.connect(self.set_units_fahrenheit)
