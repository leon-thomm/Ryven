...
class Array_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.ARRAY(self.input(0), self.input(1)))
...
class Cfunctype_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.CFUNCTYPE(self.input(0)))
...
class Dllcanunloadnow_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.DllCanUnloadNow())
...
class Dllgetclassobject_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.DllGetClassObject(self.input(0), self.input(1), self.input(2)))
...
class Pyfunctype_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.PYFUNCTYPE(self.input(0)))
...
class Setpointertype_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.SetPointerType(self.input(0), self.input(1)))
...
class Winfunctype_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.WINFUNCTYPE(self.input(0)))
...
class Winerror_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.WinError(self.input(0), self.input(1)))
...
class _Calcsize_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes._calcsize(self.input(0)))
...
class _Check_Size_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes._check_size(self.input(0), self.input(1)))
...
class _Reset_Cache_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes._reset_cache())
...
class C_Buffer_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.c_buffer(self.input(0), self.input(1)))
...
class Cast_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.cast(self.input(0), self.input(1)))
...
class Create_String_Buffer_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.create_string_buffer(self.input(0), self.input(1)))
...
class Create_Unicode_Buffer_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.create_unicode_buffer(self.input(0), self.input(1)))
...
class String_At_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.string_at(self.input(0), self.input(1)))
...
class Wstring_At_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, ctypes.wintypes.wstring_at(self.input(0), self.input(1)))
