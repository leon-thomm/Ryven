...
class _All_Tasks_Compat_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events._all_tasks_compat(self.input(0)))
...
Returns None."""
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events._enter_task(self.input(0), self.input(1)))
...
This function is thread-specific."""
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events._get_running_loop())
...
Returns None."""
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events._leave_task(self.input(0), self.input(1)))
...
Returns None."""
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events._register_task(self.input(0)))
...
This function is thread-specific."""
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events._set_running_loop(self.input(0)))
...
Returns None."""
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events._unregister_task(self.input(0)))
...
class All_Tasks_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.all_tasks(self.input(0)))
...
class As_Completed_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.as_completed(self.input(0)))
...
class Coroutine_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.coroutine(self.input(0)))
...
class Create_Subprocess_Exec_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.create_subprocess_exec(self.input(0)))
...
class Create_Subprocess_Shell_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.create_subprocess_shell(self.input(0), self.input(1), self.input(2), self.input(3), self.input(4), self.input(5)))
...
class Create_Task_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.create_task(self.input(0)))
...
class Current_Task_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.current_task(self.input(0)))
...
class Ensure_Future_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.ensure_future(self.input(0)))
...
class Gather_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.gather())
...
class Get_Child_Watcher_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.get_child_watcher())
...
the result of `get_event_loop_policy().get_event_loop()` call."""
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.get_event_loop())
...
class Get_Event_Loop_Policy_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.get_event_loop_policy())
...
This function is thread-specific."""
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.get_running_loop())
...
class Iscoroutine_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.iscoroutine(self.input(0)))
...
class Iscoroutinefunction_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.iscoroutinefunction(self.input(0)))
...
class Isfuture_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.isfuture(self.input(0)))
...
class New_Event_Loop_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.new_event_loop())
...
class Open_Connection_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.open_connection(self.input(0), self.input(1)))
...
class Run_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.run(self.input(0)))
...
class Run_Coroutine_Threadsafe_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.run_coroutine_threadsafe(self.input(0), self.input(1)))
...
class Set_Child_Watcher_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.set_child_watcher(self.input(0)))
...
class Set_Event_Loop_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.set_event_loop(self.input(0)))
...
class Set_Event_Loop_Policy_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.set_event_loop_policy(self.input(0)))
...
class Shield_Node(NodeBase):
    ...
    *except* that if the coroutine containing it is cancelled, the
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.shield(self.input(0)))
...
class Sleep_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.sleep(self.input(0), self.input(1)))
...
class Start_Server_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.start_server(self.input(0), self.input(1), self.input(2)))
...
class To_Thread_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.to_thread(self.input(0)))
...
class Wait_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.wait(self.input(0)))
...
class Wait_For_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.wait_for(self.input(0), self.input(1)))
...
class Wrap_Future_Node(NodeBase):
    ...
    def update_event(self, inp=-1):
        self.set_output_val(0, asyncio.selector_events.wrap_future(self.input(0)))
