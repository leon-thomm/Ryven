...
class Ui_FlowWindow(object):
    def setupUi(self, FlowWindow):
        ...
        self.logs_scrollArea.setGeometry(QtCore.QRect(0, 0, 821, 851))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.logs_scrollArea.sizePolicy().hasHeightForWidth())
        self.logs_scrollArea.setSizePolicy(sizePolicy)
        self.logs_scrollArea.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.logs_scrollArea.setWidgetResizable(True)
        self.logs_scrollArea.setAlignment(QtCore.Qt.AlignCenter)
        self.logs_scrollArea.setObjectName("logs_scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 819, 849))
