...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 950, 733))
        ...
        self.menuDesign_Style = QMenu(self.menuView)
        self.menuDesign_Style.setObjectName(u"menuDesign_Style")
        ...
        self.menuView.addAction(self.menuDesign_Style.menuAction())
        self.menuView.addAction(self.actionSave_Pic_Viewport)
        self.menuView.addAction(self.actionSave_Pic_Whole_Scene_scaled)
        self.menuDesign_Style.addAction(self.actionDesignDark_Std)
        self.menuDesign_Style.addAction(self.actionDesignDark_Tron)
...
"This will take a few seconds.", None))
        ...
        self.menuDesign_Style.setTitle(QCoreApplication.translate("MainWindow", u"Design Style", None))
